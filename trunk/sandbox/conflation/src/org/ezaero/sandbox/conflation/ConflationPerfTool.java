...
public class ConflationPerfTool {
    ...
    private static enum StoreMode {
        PLAIN(PlainMapPriceStore.class), SYNC_MAP(SyncMapPriceStore.class), RWLOCK_MAP(RWLockMapPriceStore.class), SYNC_MAP_ALT(
                SyncMapAltPriceStore.class), RWLOCK_MAP_ALT(RWLockMapAltPriceStore.class), SYNC_LONGMAP(SyncLongMapPriceStore.class), RWLOCK_LONGMAP(
                RWLockLongMapPriceStore.class), SYNC_LONGMAP_ALT(SyncLongMapAltPriceStore.class), RWLOCK_LONGMAP_ALT(
                RWLockLongMapAltPriceStore.class);
    ...
    private static class Setup {
        ...
        private Setup(int initSize, AccessMode mode, StoreMode store, int writerCount, int writerLoop, int writerBurstLag,
                int readerCount, int readerLoop, int readerBurstLag) {
